...
visualize(d3, data)(svg, function(next) {
  next(svg, function(next) {
    next(svg, function(next) {
...
},{"./visualize":7,"d3":5,"fs":8}],3:[function(require,module,exports){
...
function visualize(d3, src) {
  ...
  function render(svg, ready) {
    ...
    group
      ...
      .attr('opacity', 0)
      .each(fadeIn(tokens.length, 33, ready))
...
function astInitialAttributes(tokens, sel, d3) {
  ...
  function dimensions(sel) {
    ...
    return {
        x: xy[0] - 8
      , y: xy[1] - 4
      , dx: xy[0] + (+rect.attr('width')) + 5
      , dy: xy[1] + (+rect.attr('height')) + 2.5
    }
  }
...
},{"./idx-to-offset":1,"./to-children":6,"acorn":3}],8:[function(require,module,exports){
